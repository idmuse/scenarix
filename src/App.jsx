...
export default function App() {
  ...
  const newProject = (title = 'Mon scénario', format = 'fr', author = '') => { const p = createProject(title, author); p.format = format; setProjects(prev => [...prev, p]); setActiveProjectId(p.id); setView('editor') }
